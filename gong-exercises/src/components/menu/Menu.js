...
export default function Menu(props) {
    return (
        <div id="menuContainer">
            ...
            <ul id="menu">
                <MenuItem path={home_img} text="Home" clickHandler = {() => props.menuHandler(CurrentTab.HOME)}/>
                ...
                <MenuItem path={jacob_img} text="Profile" clickHandler = {() => props.menuHandler(CurrentTab.PROFILE)}/>
