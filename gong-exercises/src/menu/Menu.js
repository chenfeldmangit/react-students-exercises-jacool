    ...
    render() {
        return (
            <div id="menuContainer">
                ...
                <ul id="menu">
                    <MenuItem path="img/home.svg" text="Home" clickHandler = {() => this.props.menuHandler(CurrentTab.HOME)}/>
                    ...
                    <MenuItem path="img/jacob.jpeg" text="Profile" clickHandler = {() => this.props.menuHandler(CurrentTab.PROFILE)}/>
